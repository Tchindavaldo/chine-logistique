...
export default function GlobeTracker({
  ...
  return (
    <div ref={containerRef} className="relative flex justify-center bg-slate-100 rounded-lg overflow-hidden w-full mt-6">
        {isLoading && (
          <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-slate-100/95 backdrop-blur-sm">
            ...
            <p className="text-xs text-gray-500 mt-1">Préparation du suivi en temps réel</p>
          </div>
        )}
        <Globe
          ref={globeRef}
